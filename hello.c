...

{
  ...
  puVar10 = _refptr_mingw_app_type;
  ...
  puVar6 = _refptr___native_startup_lock;
  uVar18 = *(ulonglong *)(*(longlong *)(unaff_GS_OFFSET + 0x30) + 8);
  while( true ) {
    LOCK();
    lVar17 = *(longlong *)puVar6;
    *(ulonglong *)puVar6 =
         *(ulonglong *)puVar6 ^ (ulonglong)(lVar17 == 0) * (*(ulonglong *)puVar6 ^ uVar18);
    puVar9 = _refptr___xi_z;
    puVar8 = _refptr___xi_a;
    puVar7 = _refptr___native_startup_state;
    uVar5 = (ulonglong)(lVar17 != 0) * *(longlong *)puVar6;
    UNLOCK();
    if (uVar5 == 0) break;
    if (uVar18 == uVar5) {
      bVar20 = true;
...
LAB_004012f0:
  if ((*(int *)puVar10 != 0) &&
     (__mingw_winmain_nShowCmd = 10, ((byte)StartupInfo.dwFlags & 1) != 0)) {
  ...
  if (0 < iVar4) {
    uVar18 = 0;
    do {
      sVar15 = strlen(ppcVar11[uVar18]);
      pcVar16 = (char *)malloc(sVar15 + 1);
      ppcVar14[uVar18] = pcVar16;
      memcpy(pcVar16,ppcVar11[uVar18],sVar15 + 1);
...

{
  ...
  __security_cookie =
       ((ulonglong)DVar4 ^ (ulonglong)DVar3 ^ (ulonglong)DVar2 ^ FVar1.ft_scalar ^ perfctr.QuadPart)
       & 0xffffffffffff;
  if (__security_cookie == 0x2b992ddfa232) {
...
/* WARNING: Removing unreachable block (ram,0x004018e0) */
/* WARNING: Removing unreachable block (ram,0x004018e2) */
/* WARNING: Removing unreachable block (ram,0x004018eb) */
/* WARNING: Unknown calling convention */
...
LAB_00401d68:
      if (uVar8 == 0) {
        if (v2_hdr->version != 1) {
                    /* WARNING: Subroutine does not return */
          *(undefined **)((longlong)auStack_88 + lVar3) = &UNK_00401fa4;
        ...
        do {
          while( true ) {
            ...
            *(undefined8 *)((longlong)auStack_88 + lVar3) = 0x401f2a;
            __write_memory(addr,&reldata,4);
LAB_00401dd0:
            prVar12 = prVar12 + 1;
            if (puVar14 <= prVar12) goto LAB_00401e50;
          }
          uVar8 = (uint)bVar1;
          if (0x20 < bVar1) {
            if (uVar8 != 0x40) {
LAB_00401f81:
              reldata = 0;
                    /* WARNING: Subroutine does not return */
              *(undefined8 *)((longlong)auStack_88 + lVar3) = 0x401f98;
              __report_error("  Unknown pseudo relocation bit size %d.\n",(ulonglong)uVar8);
            }
            reldata = (*addr - (longlong)plVar11) + lVar13;
            *(undefined8 *)((longlong)auStack_88 + lVar3) = 0x401ef8;
          ...
          if (uVar8 == 8) {
            ...
            reldata = (uVar10 - (longlong)plVar11) + lVar13;
            *(undefined8 *)((longlong)auStack_88 + lVar3) = 0x401dd0;
            __write_memory(addr,&reldata,1);
            goto LAB_00401dd0;
          }
          if (uVar8 != 0x10) goto LAB_00401f81;
          uVar2 = *(ushort *)addr;
          ...
          prVar12 = prVar12 + 1;
          reldata = (uVar10 - (longlong)plVar11) + lVar13;
          *(undefined8 *)((longlong)auStack_88 + lVar3) = 0x401e41;
  ...
  do {
    ...
    *(undefined8 *)((longlong)auStack_88 + lVar3) = 0x401f77;
    __write_memory(puVar6 + uVar8,&reldata,4);
  } while (v2_hdr != (runtime_pseudo_reloc_v2 *)
                     ((longlong)pDVar4 + ((ulonglong)puVar14 & 0xfffffffffffffff8)));
LAB_00401e50:
  if (0 < maxSections) {
    lVar13 = 0;
    iVar7 = 0;
    do {
      ...
      if (flNewProtect != 0) {
        ...
        *(undefined8 *)((longlong)auStack_88 + lVar3) = 0x401e90;
...

{
  ...
  if (0xc000008b < uVar1) {
    ...
    case 0xc0000093:
      signal(8);
      pcVar2 = extraout_RAX;
      if (extraout_RAX != (code *)0x1) goto LAB_004020fd;
      signal(8);
      _fpreset();
    default:
      return 0;
...
LAB_004020fd:
      ...
      return 1;
    case 0xc0000096:
      goto switchD_00402040_caseD_c0000096;
    }
  }
  if (uVar1 == 0xc0000005) {
    signal(0xb);
...
switchD_00402040_caseD_c0000096:
    signal(4);
  ...
  if ((__mingw_init_ehandler::was_here == 0) && (BaseAddress != (PBYTE)0x0)) {
    ...
    if (p_Var3 == (PIMAGE_SECTION_HEADER)0x0) {
      ...
      do {
        ...
        if (p_Var3 == (PIMAGE_SECTION_HEADER)0x0) {
          if (eNo == 0) goto LAB_0040220c;
          EntryCount = (DWORD)eNo;
          goto LAB_004022b5;
        }
        pUVar6->VersionAndFlags = '\t';
        eNo = eNo + 1;
        pUVar6->AddressOfExceptionHandler = 0x402010 - (int)BaseAddress;
...

{
  ...
  if (0xc0000096 < uVar1) goto LAB_004023a7;
  if (uVar1 < 0xc000008c) {
    if (uVar1 == 0xc0000005) {
      signal(0xb);
      if (extraout_RAX_02 == (code *)0x1) {
    ...
    if (uVar1 != 0xc000001d) goto LAB_004023a7;
switchD_0040231c_caseD_c0000096:
    signal(4);
    if (extraout_RAX_00 == (code *)0x1) {
      signal(4);
    }
    else {
      if (extraout_RAX_00 == (code *)0x0) goto LAB_004023a7;
      (*extraout_RAX_00)(4);
    }
  }
  else {
    ...
    case 0xc0000094:
      ...
      break;
    case 0xc0000096:
      goto switchD_0040231c_caseD_c0000096;
    }
    if (pcVar3 == (code *)0x0) {
LAB_004023a7:
      if (__mingw_oldexcpt_handler == (LPTOP_LEVEL_EXCEPTION_FILTER)0x0) {
        return 0;
                    ...
                    /* WARNING: Could not recover jumptable at 0x004023bc. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  ...
  for (p_Var1 = key_dtor_list; p_Var1 != (__mingwthr_key_t *)0x0; p_Var1 = p_Var1->next) {
    ...
    if (((DWORD)value == 0) && (pvVar2 != (LPVOID)0x0)) {
      (*p_Var1->dtor)(pvVar2);
                    ...
                    /* WARNING: Could not recover jumptable at 0x004024e4. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...

{
  ...
  if ((*(short *)_refptr___image_base__ == 0x5a4d) &&
    ...
    _Str1 = (PIMAGE_SECTION_HEADER)
            (puVar5 + (ulonglong)*(ushort *)(puVar5 + (longlong)iVar3 + 0x14) +
                      (longlong)iVar3 + 0x18);
...

{
  ...
  if ((*(short *)_refptr___image_base__ == 0x5a4d) &&
    ...
    p_Var4 = (PIMAGE_SECTION_HEADER)
             (puVar5 + (ulonglong)*(ushort *)(puVar5 + (longlong)iVar2 + 0x14) +
                       (longlong)iVar2 + 0x18);
...

{
  ...
  if ((*(short *)_refptr___image_base__ == 0x5a4d) &&
    ...
    p_Var5 = (PIMAGE_SECTION_HEADER)
             (puVar4 + (ulonglong)*(ushort *)(puVar4 + (longlong)iVar2 + 0x14) +
                       (longlong)iVar2 + 0x18);
      ...
      if (*(uint *)(puVar8 + (longlong)iVar2 + 0x90) != 0) {
        ...
        if (*(ushort *)(puVar8 + (longlong)iVar2 + 6) != 0) {
          ...
          while ((uVar4 < *(uint *)(puVar5 + 0xc) ||
            ...
            puVar5 = puVar5 + 0x28;
            if (puVar5 == puVar1) goto LAB_00402a75;
          }
          for (puVar5 = puVar8 + uVar4; (*(int *)(puVar5 + 4) != 0 || (*(int *)(puVar5 + 0xc) != 0))
              ; puVar5 = puVar5 + 0x14) {
            if ((int)uVar6 < 1) {
...

{
  int iVar1;
                    ...
                    /* WARNING: Could not recover jumptable at 0x00402b00. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...

{
  int iVar1;
                    ...
                    /* WARNING: Could not recover jumptable at 0x00402b08. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...

{
  size_t sVar1;
                    ...
                    /* WARNING: Could not recover jumptable at 0x00402b10. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  sVar1 = strlen(_Str);
  return sVar1;
}
...
{
                    /* WARNING: Could not recover jumptable at 0x00402b18. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  signal(param_1);
  return;
}
...

{
  int iVar1;
                    ...
                    /* WARNING: Could not recover jumptable at 0x00402b20. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  iVar1 = puts(_Str);
  return iVar1;
}
...

{
  void *pvVar1;
                    ...
                    /* WARNING: Could not recover jumptable at 0x00402b28. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...

{
  size_t sVar1;
                    ...
                    /* WARNING: Could not recover jumptable at 0x00402b38. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...

{
  int iVar1;
                    ...
                    /* WARNING: Could not recover jumptable at 0x00402b48. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...
{
                    /* WARNING: Could not recover jumptable at 0x00402b50. Too many branches */
                    /* WARNING: Subroutine does not return */
                    /* WARNING: Treating indirect jump as call */
  exit(_Code);
  return;
...

{
  void *pvVar1;
                    ...
                    /* WARNING: Could not recover jumptable at 0x00402b58. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...

{
  _onexit_t p_Var1;
                    ...
                    /* WARNING: Could not recover jumptable at 0x00402b68. Too many branches */
                    /* WARNING: Treating indirect jump as call */
